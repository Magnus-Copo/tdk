...
/**
 * PrimaryContactSection — Light, airy contact section adapted from
 * PreschoolContactSection. Modified for tuition enquiries:
 * - "childAge" → "studentGrade" field
 * - Program dropdown → Grade-level tuition tiers
 * - Same contact info, validation, floating labels, and submit animation.
 */
    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            ...
            case 'studentName':
                ...
                return '';
            case 'studentGrade':
                if (!trimmed) return "Student's grade is required";
                return '';
            case 'program':
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await submitWeb3Form({
                ...
                subject: `Primary School Enquiry - ${formData.program}`,
                fromName: 'TDK Group Website - Primary School Form',
                replyTo: formData.email,
                fields: {
                    form_type: 'Primary School Enquiry',
            ...
            console.error('Primary form submission failed:', error);
    ...
    return (
        <>
            <style>{`
                ...
                .primary-contact-card-info {
                    transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1),
                                box-shadow 0.3s cubic-bezier(0.4, 0, 0.2, 1),
                                border-color 0.3s ease;
                }
                .primary-contact-card-info:hover {
            ...
            <section
                ...
                style={{
                    padding: 'clamp(40px, 6vw, 76px) clamp(16px, 4vw, 24px) clamp(60px, 10vw, 120px)',
                    background: 'linear-gradient(180deg, #FFFFFF 0%, #EFF6FF 30%, #DBEAFE 70%, #EFF6FF 100%)',
                    position: 'relative',
                }}
            >
                ...
                <div className="max-w-[1280px] mx-auto px-2 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start relative z-10">
                    ...
                    >
                        ...
                        <p
                            style={{
                                fontFamily: "'Nunito', 'Inter', sans-serif",
                                color: '#475569', fontSize: '1.02rem', lineHeight: 1.75,
                                letterSpacing: '0.005em',
                                maxWidth: '480px', marginBottom: '40px',
                            }}
                        >
                            Interested in our tuition programs? Reach out to learn more about
                            admissions, schedules, and how we can help your child excel across CBSE, ICSE,
                            or Karnataka State Board.
                        </p>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            {contactItems.map((item, index) => (
                                <motion.div
                                    key={item.title}
                                    className={`primary-contact-card-info ${item.title === 'Visit Us' ? 'primary-visit-card' : ''}`}
                                ...
                                >
                                    ...
                                    <div>
                                        <h4
                                            className={item.title === 'Visit Us' ? 'primary-visit-heading' : ''}
                                            style={{
                                            fontFamily: "'Nunito', sans-serif",
                                        ...
                                        <p style={{ fontFamily: "'Nunito', 'Inter', sans-serif", color: '#334155', fontSize: '0.95rem', margin: 0, lineHeight: 1.65, letterSpacing: '0.005em' }}>
                                            {item.detail}
                                        </p>
                                        {item.sub && (
                                            <p style={{ fontFamily: "'Nunito', 'Inter', sans-serif", color: '#64748B', fontSize: '0.85rem', margin: '3px 0 0 0', fontWeight: 500, letterSpacing: '0.01em' }}>
                                                {item.sub}
                                            </p>
                                        )}
                                    </div>
                    ...
                    >
                        ...
                        <p style={{ fontFamily: "'Nunito', 'Inter', sans-serif", color: '#64748B', fontSize: '0.92rem', marginBottom: '28px', marginTop: '0', letterSpacing: '0.005em' }}>
                        ...
                        <AnimatePresence mode="wait">
                            {submitStatus === 'success' ? (
                                ...
                                >
                                    ...
                                    {/* Row 2 */}
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <PrimaryFormField label="Student's Name" name="studentName" focusedField={focusedField} errors={errors} formData={formData} handleChange={handleChange} setFocusedField={setFocusedField} />
                                        <PrimaryFormField label="Current Grade / Class" name="studentGrade" focusedField={focusedField} errors={errors} formData={formData} handleChange={handleChange} setFocusedField={setFocusedField} />
                                    </div>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        ...
                                        >
                                            ...
                                            <option value="Grade 1-4 Tuition">Foundation — Grades 1 – 4</option>
                                            <option value="Grade 5-7 Tuition">Intermediate — Grades 5 – 7</option>
                                            <option value="Grade 8-9 Tuition">Advanced — Grades 8 – 9</option>
                                            <option value="Grade 10 Tuition">Board Exam Mastery — Grade 10</option>
                                        </select>
                                        <AnimatePresence>
                                            {errors.program && (
                                                <motion.p
